...
# chaincode requests through the qnb peers to check that qnb was
...
# Query chaincode on peer0.qnb, check if the result is 90
echo "Querying chaincode on peer0.qnb..."
chaincodeQuery 0 3 90

# Invoke chaincode on peer0.cib, peer0.hsbc, and peer0.qnb
echo "Sending invoke transaction on peer0.cib peer0.hsbc peer0.qnb..."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0.qnb, peer0.hsbc, peer0.cib check if the result is 80
...
echo "Querying chaincode on peer0.hsbc..."
